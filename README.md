...
```
ts_library(name, compile_angular_templates, compiler, data, deps, expected_diagnostics, generate_externs, internal_testing_type_check_dependencies, module_name, module_root, node_modules, rh_module_override, rh_target_override, runtime, runtime_deps, srcs, supports_workers, tsconfig, tsickle_typed)
```
...
Defaults to `:rh_module_override`

#### `rh_target_override`
(*[label]*)

Defaults to `:rh_target_override`
